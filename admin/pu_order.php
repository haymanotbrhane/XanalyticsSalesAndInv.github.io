                            ...
                            <table class="table table-responsive-lg table-bordered table-striped mb-0"
                                ...
                                while ($row = mysqli_fetch_assoc($order)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo find_product_by_id(find_purchase_request_by_id($row["pu_request_id"])["item_id"])["code"] . " / " . find_product_by_id(find_purchase_request_by_id($row["pu_request_id"])["item_id"])["title"]; ?></td>
...
function receiveOrder() {
    ...
    $.ajax({
        type: "POST",
        url: "generated/purchase.php",
        data: "por_id=" + po_id + "&receive_quantity=" + re_quantity + "&plate_no=" + plate_no + "&driver_name=" + driver_name + "&driver_phone=" + driver_phone,
        success: function (response) {
            window.location = "pu_order.php";
        }
