...
<?php
$k = 6;
$cate = find_category_by_id($_GET["id"]);
...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["category"])) {
        ...
        $query .= ",description = N'{$description}'";
        $query .= ",last_update_by = {$user_id} ";
        $query .= "WHERE id = '{$id}'; ";
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="title" value="<?php echo $cate["title"]; ?>" class="form-control" data-plugin-maxlength
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select name="category" data-plugin-selectTwo class="form-control populate" required>
                                    <option value="">Select Type</option>
                                    <option value="1" <?php echo $cate["category"]==="1"?"selected":""; ?>>Finished Product</option>
                                    <option value="2" <?php echo $cate["category"]==="2"?"selected":""; ?>>Raw Material</option>
                                </select>
                            </div>
                        </div>
