...
<?php
$k = 1;
$cate = find_logistic_category_by_id($_GET["id"]);
...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["amount"])) {
        ...
        $jcatam = trim($_POST["amount"]);


        $query = "UPDATE logistic_category SET ";
        $query .= "title = N'{$jcat}'";
        $query .= ",amount = N'{$jcatam}'";
        $query .= "WHERE id = '{$id}'; ";
    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-right">
            <ol class="breadcrumbs">
                ...
                <li><span>LogisticCategory</span></li>
            </ol>
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Edit Logistic Category</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Amount</label>

                            <div class="col-lg-4">
                                <input type="text" name="amount" value="<?php echo $cate["amount"]; ?>" class="form-control"
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="submit" name="submit" style="float: right"
                                       ...
                                       value="Update Logistic Category">
                            </div>
                        </div>
                        <br>
                        <br>
