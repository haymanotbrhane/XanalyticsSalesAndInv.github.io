...
$request = find_all_order_request();
$k = 1;
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Order Request List</h2>
                </header>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        while ($row = mysqli_fetch_assoc($request)) {
                            ...
                            <tr class="<?php echo $row["status"] == 1 ? "success" : ""; ?>">
                                ...
                                <td><?php echo find_vehicle_by_id($row["vehicle_id"])["plate_no"]; ?></td>
                                ...
                                <td class="actions">
                                    <a href="addOrderRespons.php?id=<?php echo urldecode($row["id"]); ?>"
                                       class=" on-editing save-row"><i class="fa fa-link"></i></a>
                                    <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                    <a href="editOrderRequest.php?id=<?php echo urldecode($row["id"]); ?>"
                                       class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                    <a href="deleteOrderRequest.php?id=<?php echo urldecode($row["id"]); ?>"
