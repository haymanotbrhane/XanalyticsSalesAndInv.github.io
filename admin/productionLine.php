...
<?php
$production = find_all_productionLine();
$k = 1;
    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-right">
            <ol class="breadcrumbs" style="margin-right: 50px;">
                ...
                <li><span>Production Line</span></li>
            </ol>
        </div>
    </header>
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Production Line List</h2>
                </header>
                <div class="card-body">
                        ...
                        while ($row = mysqli_fetch_assoc($production)) {
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="deleteProductionLine.php?id=<?php echo $row["id"] . ''; ?>"
