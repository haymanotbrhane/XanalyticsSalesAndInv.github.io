...
<?php
$production = find_all_productionShift();
$k = 1;
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Production Shift List</h2>
                </header>
                <div class="card-body">
                        ...
                        while ($row = mysqli_fetch_assoc($production)) {
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="deleteProductionShift.php?id=<?php echo $row["id"] . ''; ?>"
