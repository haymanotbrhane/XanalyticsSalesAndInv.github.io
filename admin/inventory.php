        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <div class="col-md-12">
                        <h2 class="card-title">Damage Item Inventory</h2>
                    </div>
                </header>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-responsive-lg table-bordered table-striped mb-0"
                        ...
                        <tbody>
                        <?php
                        while ($row = mysqli_fetch_assoc($d_inv)) {
                            ?>
                            <tr>
                                <td><?php echo find_product_by_id($row["item_id"])["code"] . " / " . find_product_by_id($row["item_id"])["title"]; ?></td>
                                <td><?php echo (find_category_by_id(find_product_by_id($row["item_id"])["category"])["category"] == 1) ? "Finished Product" : "Raw Material"; ?></td>
