...
if (isset($_POST["submit"])) {
    if (isset($_POST["ref"]) && isset($response["id"])) {
        ...
        $check = find_goods_receive_by_ref($ref);
        if (empty($check)) {
            create_goods_receive($r_id, $ref, $damage, $shortage, $over, $remark, $u_id);
        } else {
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Create Goods Receive / GRN</h2>
                </header>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="ref" class="form-control" data-plugin-maxlength
                                       maxlength="200" value="GRN" required/>
