                        ...
                        while ($row = mysqli_fetch_assoc($category)) {
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <a href="editPriceCategory.php?id=<?php echo urldecode($row["id"]); ?>"
                                       class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                    <a href="deletePriceCategory.php?id=<?php echo $row["id"] . ''; ?>"
