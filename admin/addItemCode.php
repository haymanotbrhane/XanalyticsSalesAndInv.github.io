...
if (isset($_POST["submit"])) {
    if (isset($_POST["item_code"])) {
        ...
        $title = $_POST["item_code"];
        $image = upload_image('logo');

        create_item_code($title, $image);
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Create Item Code</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="item_code" class="form-control" data-plugin-maxlength
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2"
                                   for="textareaDefault">Sample Image</label>
