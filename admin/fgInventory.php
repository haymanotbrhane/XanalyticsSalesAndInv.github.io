        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <div class="col-md-12">
                        <h2 class="card-title">Finished Good Inventory</h2>
                    </div>
                </header>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-responsive-lg table-bordered table-striped mb-0"
                        ...
                        <tbody>
                        <?php
                        while ($row = mysqli_fetch_assoc($f_inv)) {
                            $type = "";
                            ...
                            <tr>
                                ...
                                <td><?php echo number_format($row["quantity"], 0, '.', ',') . ' ' . find_product_by_id($row["item_id"])["measurment"]; ?></td>
                                <td>
                                    <?php
                                    echo number_format($type, 0, '.', ',') . ' ' . find_product_by_id($row["item_id"])["measurment"];
                                    ?>
                                </td>
                                <td>
