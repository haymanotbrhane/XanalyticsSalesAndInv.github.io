...
(function ($) {
    ...
    */
    (function () {
        if ($('#flotBars1').get(0)) {
            var plot = $.plot('#flotBars1', [flotBarsData], {
                colors: ['#8CC9E8'],
                series: {
                    bars: {
                        show: true,
    ...
    */
    if ($('#morrisDonut').get(0)) {
        Morris.Donut({
            ...
            colors: ['#0088cc', '#734ba9', '#E36159', '#66E358']
        });
    }
    ...
    */
    ...
    if ($('#morrisBar0').get(0)) {
        Morris.Bar({
            ...
            xkey: 'y',
            ykeys: ['a', 'b', 'c', 'd', 'e'],
            labels: ['Top 1 qty', 'Top 2 qty', 'Top 3 qty', 'Top 4 qty', 'Top 5 qty'],
            hideHover: true,
            barColors: ['#00CC21', '#4B7A25', '#CACC20', '#109618', '#DC3912']
        });
    }
    ...
    */
    ...
    if ($('#sparklinePie1').get(0)) {
        $("#sparklinePie1").sparkline(sparklinePieData, {
            type: 'pie',
            height: '300',
            barColor: '#0088cc'
        });
