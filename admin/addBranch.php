...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["phone"])) {
        ...
        create_branch($title, $location, $phone, $b_type);
    } else {
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Create Branch/Warehouse</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Branch Name</label>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Branch Type</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="phone" class="form-control" data-plugin-maxlength
