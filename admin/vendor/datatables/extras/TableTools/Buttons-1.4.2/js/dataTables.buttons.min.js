...
(function (d) {
    ...
    d.extend(m.prototype, {
        action: function (a, b) {
            ...
            var c =
                this.c.dom.button, e = this.c.dom.buttonLiner, g = this.c.dom.collection, h = this.s.dt, f = function (b) {
            ...
            if (a.key) {
                var b = d.isPlainObject(a.key) ?
                    a.key.key : a.key, a = this.s.listenKeys.split(""), b = d.inArray(b, a);
                a.splice(b, 1);
    ...
    d.extend(j, {
        collection: {
            ...
            }, className: "buttons-collection", action: function (a, b,
                                                                  c, e) {
