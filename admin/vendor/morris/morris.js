    ...
    Morris.Bar = (function (_super) {
        ...
        Bar.prototype.drawXAxis = function () {
            ...
            for (i = _i = 0, _ref = this.data.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
                ...
                label = this.drawXAxisLabel(row._x, ypos, row.label,row.y);
                textBox = label.getBBox();
        ...
        Bar.prototype.drawXAxisLabel = function (xPos, yPos, text,yKeys) {
            var label;
            return label = this.raphael.text(xPos, yPos, text + " ( "+yKeys + ")").attr('font-size', this.options.gridTextSize).attr('font-family', this.options.gridTextFamily).attr('font-weight', this.options.gridTextWeight).attr('fill', this.options.gridTextColor);
        };
