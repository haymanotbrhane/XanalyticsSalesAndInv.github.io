...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["attribute"])) {
        ...
        $query = "UPDATE attribute_value SET ";
        $query .= "title = '{$title}'";
        $query .= ",attribute_id = {$attribute} ";
        $query .= "WHERE id = {$id}; ";
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Update Attribute Value</h2>
                </header>
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="title" class="form-control" data-plugin-maxlength
                                       maxlength="100" value="<?php echo $attribute_value["title"] ?>" required/>
                            ...
                            <div class="col-lg-4">
                                <select name="attribute" data-plugin-selectTwo class="form-control populate"
                                    ...
                                    while ($row = mysqli_fetch_assoc($attribute)) {
                                        ?>
                                        <option <?php echo $row["id"] === $attribute_value["attribute_id"] ? "selected" : ""; ?>
