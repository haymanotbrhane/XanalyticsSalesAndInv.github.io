...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["plate"]) && isset($_POST["c_id"]) && isset($_POST["cate"])) {
        ...
        $query .= "title = '{$title}'";
        $query .= ",plate_no = '{$plate_no}'";
        $query .= ",customer_id = {$c_id}";
        $query .= ",driver_name = '{$d_name}' ";
        $query .= ",driver_number = '{$d_number}' ";
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="title" class="form-control"
                                       value="<?php echo $vehicle["title"]; ?>" data-plugin-maxlength
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="plate" class="form-control" data-plugin-maxlength
                                       value="<?php echo $vehicle["plate_no"]; ?>"
                                       maxlength="200" required/>
                            ...
                            <div class="col-lg-4">
                                <select name="c_id" id="c_id" data-plugin-selectTwo class="form-control populate"
                                    ...
                                    while ($row = mysqli_fetch_assoc($customer)) {
                                        ?>
                                        <option <?php echo ($row["id"] === $vehicle["customer_id"]) ? 'selected' : ""; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="d_name" class="form-control"
                                       value="<?php echo $vehicle["driver_name"]; ?>" data-plugin-maxlength
                                       maxlength="200" required/>
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="d_number"
                                           value="<?php echo '09' . $vehicle["driver_number"]; ?>"
                            ...
                            <div class="col-lg-4">
                                <select name="cate" id="cate" data-plugin-selectTwo class="form-control populate">
                                    ...
                                    while ($row = mysqli_fetch_assoc($category)) {
                                        ?>
                                        <option <?php echo ($row["id"] === $vehicle["category_id"]) ? 'selected' : ""; ?>
