...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["phone"])) {
    ...
    <header class="page-header">
        ...
        <div class="right-wrapper text-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Branch/Warehouse</span></li>
            </ol>
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Edit Branch/Warehouse</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" name="title" value="<?php echo $branch["title"]; ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select name="b_type" data-plugin-selectTwo class="form-control populate">
                                    <option value="Warehouse" <?php echo $branch["branch_type"] === "Warehouse" ? "selected" : ""; ?> >
                                        Warehouse
                                    </option>
                                    <option
                                            value="Shop" <?php echo $branch["branch_type"] === "Shop" ? "selected" : ""; ?> >
                                        Shop
                                    </option>
                                    <option
                                            value="Showroom" <?php echo $branch["branch_type"] === "Showroom" ? "selected" : ""; ?> >
                                        Showroom
                                    </option>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Mobile Number</label>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2"
                                   for="textareaDefault">Location</label>

                            <div class="col-lg-4">
                                <textarea class="form-control"
                                          name="location"><?php echo $branch["location"]; ?></textarea>
